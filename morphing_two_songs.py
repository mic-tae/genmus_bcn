from nmf_morph_dafx2020_python.nmf_morph import NMFMorph
from nmf_morph_dafx2020_python.untwist.untwist.data import Wave
from nmf_morph_dafx2020_python.rtpghi import pghi
import nmf_morph_dafx2020_python.consts as cnst

from nmf_morph_dafx2020_python.interpolate import *

from music_info_retrieval.songs_concatenation import Song_concatenator, Beat_detector, BEATNET_PATH
...
if __name__ == "__main__":
    ...
    parser.add_argument('--first_song', type=str, help='Path to the first song', default="music_info_retrieval/test/house120.mp3")
    parser.add_argument('--second_song', type=str, help='Path to the second song', default="music_info_retrieval/test/2house120.mp3")
